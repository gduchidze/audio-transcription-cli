...
class LFM2AudioWrapper:
    ...
    def transcribe_with_real_timing(
        ...
        for chunk_path, chunk_start, chunk_end in chunker.create_chunks(audio_path):
            ...
            if chunk_transcription.strip():
                ...
                if text_cleaner:
                    ...
                    new_content = self._extract_new_content(cleaned_context, already_displayed_parts,
                                                            chunk_transcription)
                else:
        ...
        full_transcription = " ".join(already_displayed_parts) if already_displayed_parts else " ".join(
