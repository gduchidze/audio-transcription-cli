...
def cli():
    ...
    parser.add_argument("--log-partial-transcripts",
                        help="CSV file path in datasets/ to log incremental chunk transcriptions")
    parser.add_argument("--typewriter", action="store_true", default=True,
                        help="Enable typewriter effect for character-by-character display (default: enabled)")
    parser.add_argument("--typewriter-speed", type=float, default=0.01,
                        help="Speed of typewriter effect in seconds per character (default: 0.01)")
    args = parser.parse_args()

    main(args.audio, args.play_audio, args.clean_text, args.log_partial_transcripts, args.typewriter,
